...
public class FlexibleColorPicker : MonoBehaviour {
    ...
    public eventoColore.Evento evento = new eventoColore.Evento();
    ...
    */
    ...
    public void PointerUpdate(BaseEventData e) {
        ...
        typeUpdate = true;
        UpdateHex();
        MoreMountains.NiceVibrations.MMVibrationManager.TransientHaptic(.3f, .8f); ;
    }
